...
let contractAddress = "0x55005133638FDcd4Cf987b483f304B24b9196996";
...
const addPassenger = async() => {
    ...
    await contract.methods.addPassenger(_passengerId,_flightno,_from,_to,_date,_pnrno,_email).send({ from: adminId, gas: 3000000 }).then(e => res = e)
    if (res)
